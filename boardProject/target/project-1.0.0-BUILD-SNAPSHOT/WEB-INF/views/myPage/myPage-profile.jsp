       ...
       <jsp:include page="/WEB-INF/views/common/header.jsp"/>
        ...
        <section class="myPage-content">
            ...
            <section class="myPage-main">
                ...
                <%--
                - 파일 제출 시 무조건 POST 방식 
				- enctype : form 태그 데이터가 서버로 제출 될 때 인코딩 되는 방법을 지정(POST 방식일때만 사용 가능)
				- aplicattion/x-www-form-urlencoded : 모든 문자를 서버로 전송하기 전에 인코딩(form 태그 기본값)                
                ...
                <form action="profile" method="POST" name="myPageFrm" id="profileFrm" enctype="multipart/form-data">
                    ...
                    <div class="profile-image-area">
						...
						<c:if test="${not empty loginMember.profileImage}">
						 <img src="${login.Member.profileImage}" id="profileImage">
						</c:if>
